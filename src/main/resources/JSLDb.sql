...
-- WITHIN_REP_COUNTER_VIEW represents a reduced view of within replication counter containing only the last value for the replication   
...
-- PW_DIFF_AR_REP_VIEW computes across replication statistics on the pair wise data within PW_DIFF_WITHIN_REP_VIEW      
-- doesn't work for derby, 3-28-2019, works for postgres and HSQLDB
