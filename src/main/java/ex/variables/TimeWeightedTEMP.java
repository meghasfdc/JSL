 ...
 *
 */
public class TimeWeightedTEMP extends ResponseVariable {
     ...
     */
    public TimeWeightedTEMP(ModelElement parent) {
     ...
     */
    public TimeWeightedTEMP(ModelElement parent, double initialValue) {
     ...
     */
    public TimeWeightedTEMP(ModelElement parent, String name) {
     ...
     * @param name The name of the variable.
     */
    public TimeWeightedTEMP(ModelElement parent, double initialValue, String name) {
     ...
     * @param name The name of the variable.
     */
    public TimeWeightedTEMP(ModelElement parent, double initialValue, double lowerLimit, String name) {
     ...
     * &lt; upperLimit
     */
    public TimeWeightedTEMP(ModelElement parent, double initialValue, double lowerLimit) {
     ...
     */
    public TimeWeightedTEMP(ModelElement parent, double initialValue, double lowerLimit, double upperLimit) {
     ...
     * @param name The name of the variable.
     */
    public TimeWeightedTEMP(ModelElement parent, double initialValue, double lowerLimit, double upperLimit, String name) {
...
//		System.out.println("In TimeWeightedTEMP initialize() " + getName());
        super.initialize();
