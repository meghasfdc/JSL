...
public class MultipleComparisonAnalyzer {
    ...
    public double getDiffBtwItemAndMaxOfRest(int index) {
        double[] avgs = getAveragesOfData();
        double[] avgsWO = JSLMath.copyWithout(index, avgs);
        double max = JSLMath.getMax(avgsWO);
    ...
    public double getDiffBtwItemAndMinOfRest(int index) {
        double[] avgs = getAveragesOfData();
        double[] avgsWO = JSLMath.copyWithout(index, avgs);
        double min = JSLMath.getMin(avgsWO);
    ...
    public Interval getMCBMaxInterval(int index) {
        return getMCBMaxInterval(index, 0);
    }
     ...
     *
     * @param index
     * @param delta must be 0 or bigger
     * @return
     */
    ...
    /**
     * Forms all MCB intervals for the maximum given zero indifference
     *
     * @return
     */
    public List<Interval> getMCBMaxIntervals() {
        return getMCBMaxIntervals(0.0);
    }
     ...
     * names of the data sets with indifference delta 0.0
     *
     * @return
     */
    public Map<String, Interval> getMCBMaxIntervalsAsMap() {
        return getMCBMaxIntervalsAsMap(0.0);
    }
    ...
    public StringBuilder getMCBMaxIntervalsAsSB() {
        return getMCBMaxIntervalsAsSB(0.0);
    }
    ...
    public Interval getMCBMinInterval(int index) {
        return getMCBMinInterval(index, 0);
    }
    ...
    /**
     * Forms all MCB intervals for the minimum given zero indifference
     *
     * @return
     */
    public List<Interval> getMCBMinIntervals() {
        return getMCBMinIntervals(0.0);
    }

    /**
     * Forms all MCB intervals for the minimum given the supplied delta
     *
     * @param delta
     * @return
     */
    ...
    public Map<String, Interval> getMCBMinIntervalsAsMap() {
        return getMCBMinIntervalsAsMap(0.0);
    }
    ...
    public StringBuilder getMCBMinIntervalsAsSB() {
        return getMCBMinIntervalsAsSB(0.0);
    }
