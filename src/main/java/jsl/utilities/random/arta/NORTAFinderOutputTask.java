 ...
 *
 */
public class NORTAFinderOutputTask extends TimerTask {

	protected BivariateNORTACorrelationFinder myCF;
	
	/**
	 * 
	 */
	public NORTAFinderOutputTask(BivariateNORTACorrelationFinder b) {
		myCF = b;
	}
	...
	public void run() {
		if (myCF == null){
			System.out.println("The BivariateNORTACorrelationFinder was null");
			return;
		}
