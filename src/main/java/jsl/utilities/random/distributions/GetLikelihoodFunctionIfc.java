...
/**
 *  An interface to promise to supply the likelihood function given a set of
 *  data.  Distributions can implement this interface to return an appropriately
 *  instance of their likelihood function
 */
public interface GetLikelihoodFunctionIfc {
     ...
     * the interface
     */
    FunctionMVIfc getLikelihoodFunction(double[] data);
