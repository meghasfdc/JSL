...
public class Keys {
    ...
    public static final UniqueKey<AcrossRepStatRecord> SQL190415110855930 = UniqueKeys0.SQL190415110855930;
    public static final UniqueKey<BatchStatRecord> SQL190415110856020 = UniqueKeys0.SQL190415110856020;
    ...
    public static final UniqueKey<SimulationRunRecord> SQL190415110855730 = UniqueKeys0.SQL190415110855730;
    public static final UniqueKey<SimulationRunRecord> SR_NAME_EXP_UNIQUE = UniqueKeys0.SR_NAME_EXP_UNIQUE;
    public static final UniqueKey<WithinRepCounterStatRecord> SQL190415110855980 = UniqueKeys0.SQL190415110855980;
    ...
    public static final UniqueKey<WithinRepStatRecord> SQL190415110855880 = UniqueKeys0.SQL190415110855880;
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        public static final UniqueKey<AcrossRepStatRecord> SQL190415110855930 = createUniqueKey(AcrossRepStat.ACROSS_REP_STAT, "SQL190415110855930", AcrossRepStat.ACROSS_REP_STAT.ID);
        public static final UniqueKey<BatchStatRecord> SQL190415110856020 = createUniqueKey(BatchStat.BATCH_STAT, "SQL190415110856020", BatchStat.BATCH_STAT.ID);
        ...
        public static final UniqueKey<SimulationRunRecord> SQL190415110855730 = createUniqueKey(SimulationRun.SIMULATION_RUN, "SQL190415110855730", SimulationRun.SIMULATION_RUN.ID);
        ...
        public static final UniqueKey<WithinRepCounterStatRecord> SQL190415110855980 = createUniqueKey(WithinRepCounterStat.WITHIN_REP_COUNTER_STAT, "SQL190415110855980", WithinRepCounterStat.WITHIN_REP_COUNTER_STAT.ID);
        ...
        public static final UniqueKey<WithinRepStatRecord> SQL190415110855880 = createUniqueKey(WithinRepStat.WITHIN_REP_STAT, "SQL190415110855880", WithinRepStat.WITHIN_REP_STAT.ID);
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        ...
        public static final ForeignKey<AcrossRepStatRecord, SimulationRunRecord> ARS_SIMRUN_FK = createForeignKey(jsl.utilities.jsldbsrc.Keys.SQL190415110855730, AcrossRepStat.ACROSS_REP_STAT, "ARS_SIMRUN_FK", AcrossRepStat.ACROSS_REP_STAT.SIM_RUN_ID_FK);
        ...
        public static final ForeignKey<BatchStatRecord, SimulationRunRecord> BS_SIMRUN_FK = createForeignKey(jsl.utilities.jsldbsrc.Keys.SQL190415110855730, BatchStat.BATCH_STAT, "BS_SIMRUN_FK", BatchStat.BATCH_STAT.SIM_RUN_ID_FK);
        public static final ForeignKey<ModelElementRecord, SimulationRunRecord> ME_SIMRUN_FK = createForeignKey(jsl.utilities.jsldbsrc.Keys.SQL190415110855730, ModelElement.MODEL_ELEMENT, "ME_SIMRUN_FK", ModelElement.MODEL_ELEMENT.SIM_RUN_ID_FK);
        ...
        public static final ForeignKey<WithinRepCounterStatRecord, SimulationRunRecord> WRCS_SIMRUN_FK = createForeignKey(jsl.utilities.jsldbsrc.Keys.SQL190415110855730, WithinRepCounterStat.WITHIN_REP_COUNTER_STAT, "WRCS_SIMRUN_FK", WithinRepCounterStat.WITHIN_REP_COUNTER_STAT.SIM_RUN_ID_FK);
        ...
        public static final ForeignKey<WithinRepStatRecord, SimulationRunRecord> WRS_SIMRUN_FK = createForeignKey(jsl.utilities.jsldbsrc.Keys.SQL190415110855730, WithinRepStat.WITHIN_REP_STAT, "WRS_SIMRUN_FK", WithinRepStat.WITHIN_REP_STAT.SIM_RUN_ID_FK);
    }
}
