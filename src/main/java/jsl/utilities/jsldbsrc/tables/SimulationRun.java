...
public class SimulationRun extends TableImpl<SimulationRunRecord> {
    ...
    private static final long serialVersionUID = -1980324654;
     ...
     */
    public final TableField<SimulationRunRecord, String> SIM_NAME = createField("SIM_NAME", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>APP.SIMULATION_RUN.MODEL_NAME</code>.
     */
    public final TableField<SimulationRunRecord, String> MODEL_NAME = createField("MODEL_NAME", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>APP.SIMULATION_RUN.EXP_NAME</code>.
     */
    public final TableField<SimulationRunRecord, String> EXP_NAME = createField("EXP_NAME", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    public UniqueKey<SimulationRunRecord> getPrimaryKey() {
        return Keys.SQL180330135926140;
    }
    ...
    public List<UniqueKey<SimulationRunRecord>> getKeys() {
        return Arrays.<UniqueKey<SimulationRunRecord>>asList(Keys.SQL180330135926140);
    }
