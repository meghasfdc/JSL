...
public class BatchStat extends TableImpl<BatchStatRecord> {
    ...
    private static final long serialVersionUID = -874867701;
    ...
    public UniqueKey<BatchStatRecord> getPrimaryKey() {
        return Keys.SQL180614115403990;
    }
    ...
    public List<UniqueKey<BatchStatRecord>> getKeys() {
        return Arrays.<UniqueKey<BatchStatRecord>>asList(Keys.SQL180614115403990);
    }
