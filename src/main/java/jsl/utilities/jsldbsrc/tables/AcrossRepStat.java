...
public class AcrossRepStat extends TableImpl<AcrossRepStatRecord> {
    ...
    private static final long serialVersionUID = 1878078160;

    /**
     * The reference instance of <code>APP.ACROSS_REP_STAT</code>
     */
    ...
    /**
     * The column <code>APP.ACROSS_REP_STAT.ID</code>.
     */
    ...
    /**
     * The column <code>APP.ACROSS_REP_STAT.MODEL_ELEMENT_NAME</code>.
     */
    public final TableField<AcrossRepStatRecord, String> MODEL_ELEMENT_NAME = createField("MODEL_ELEMENT_NAME", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>APP.ACROSS_REP_STAT.SIM_RUN_ID_FK</code>.
     */
    ...
    /**
     * The column <code>APP.ACROSS_REP_STAT.STAT_NAME</code>.
     */
    public final TableField<AcrossRepStatRecord, String> STAT_NAME = createField("STAT_NAME", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>APP.ACROSS_REP_STAT.STAT_COUNT</code>.
     */
    ...
    /**
     * The column <code>APP.ACROSS_REP_STAT.CONF_LEVEL</code>.
     */
    ...
    /**
     * The column <code>APP.ACROSS_REP_STAT.SUM_OF_WEIGHTS</code>.
     */
    ...
    /**
     * The column <code>APP.ACROSS_REP_STAT.WEIGHTED_SSQ</code>.
     */
    ...
    /**
     * The column <code>APP.ACROSS_REP_STAT.LAST_WEIGHT</code>.
     */
    ...
    /**
     * The column <code>APP.ACROSS_REP_STAT.NUM_MISSING_OBS</code>.
     */
    ...
    /**
     * Create a <code>APP.ACROSS_REP_STAT</code> table reference
     */
    ...
    /**
     * Create an aliased <code>APP.ACROSS_REP_STAT</code> table reference
     */
    ...
    public UniqueKey<AcrossRepStatRecord> getPrimaryKey() {
        return Keys.SQL180330135926290;
    }
    ...
    public List<UniqueKey<AcrossRepStatRecord>> getKeys() {
        return Arrays.<UniqueKey<AcrossRepStatRecord>>asList(Keys.SQL180330135926290);
    }
