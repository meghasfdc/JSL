 ...
 *
 */
public abstract class SpatialModel extends Observable implements IdentityIfc {

    /**
     * An "enum" to indicate that a element has been added when notifying
     * observers
     */
    public static final int ADDED_ELEMENT = JSL.getNextEnumConstant();

    /**
     * An "enum" to indicate that a element has been reomved when notifying
     * observers
     */
    public static final int REMOVED_ELEMENT = JSL.getNextEnumConstant();

    /**
     * An enum to indicate that the spatial model as just updated the position
     * of a element
     */
    public static final int UPDATED_POSITION = JSL.getNextEnumConstant();
