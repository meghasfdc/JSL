    ...
    protected void setTraceObserver(String name, boolean header) {
        ...
        if (myVariableTraceTextReport == null) {
            ...
            if (getSimulation() != null) {
                File directory = JSL.makeOutputSubDirectory(getSimulation().getName());
                myVariableTraceTextReport = new VariableTraceTextReport(directory, theFixedName + "_Trace", header);
            } else {
                myVariableTraceTextReport = new VariableTraceTextReport(theFixedName + "_Trace", header);
            }
