 ...
 *
 */
public class JSLEventException extends RuntimeException {

	private static final long serialVersionUID = -5679565114648868196L;

    /**
     *
     */
    public JSLEventException(){
        super("JSLEvent Exception!");
    }
    
    /**
     * 
     * @param m a string for the message
     */
    public JSLEventException(String m){
        super(m);
    }
}