...
public class Queue<T extends QObject> extends ModelElement implements
     ...
     */
    protected QueueResponse myResponses;
...
//    }
     ...
     * @param priority
     */
    public final void changePriority(T qObject, int priority) {
    ...
    public final void enqueue(T queueingObject) {
        enqueue(queueingObject, 1, queueingObject.getAttachedObject());
    }
    ...
    abstract private class QueueDiscipline {
         ...
         * @param priority
         */
        protected void changePriority(T qObject, int priority) {
